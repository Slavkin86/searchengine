package org.example;
import org.example.dop.Connections;
import org.example.dop.MetroMap;
import org.example.dop.Station;
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        jsonWriter.writeInJSONFile(metro.getMetroObject(), "resources/metro.json");
        JSONReader jsonReader = new JSONReader();
        jsonReader.getAmountOfStations("resources/metro.json");

        DataCollector collector = new DataCollector();
        collector.fileReader("resources/data");
        ...
        jsonWriter1.writeInJSONFile(stationObject, "resources/stations.json");
    }
